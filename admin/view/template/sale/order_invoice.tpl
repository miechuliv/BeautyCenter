...
<div style="page-break-after: always;">
  ...
  <?php } ?>
  <!-- Novalnet data -->
  <?php foreach ($order['novalnet_trans'] as $novalnet_transaction) { ?>
  <table class="comment" width="100%" style="margin-top:20px;">
    <tr class="heading">
      <td><b><?php echo 'Novalnet Transaction'; ?></b></td>
    </tr>
    <tr>
      <td><?php echo $novalnet_transaction['comment']; ?></td>
    </tr>
  </table>  
  <?php } ?>
   <!-- Novalnet data -->
