...
$_['heading_title']      		= 'Novalnet Kauf auf Rechnung';
$_['admin_heading_title']   	= '<div style="float:left"><a href=\''.$shop_url.'www.novalnet.de\' target=\'_blank\'"><img src="'.$shop_url.'www.novalnet.de/img/NN_Logo_T.png" border="0" alt="novalnet.de" title="Novalnet AG" height="23" /></a> </div><div style="float:right"><a href=\''.$shop_url.'www.novalnet.de\' target=\'_blank\'"><img src="'.$shop_url.'www.novalnet.de/img/kauf-auf-rechnung.jpg" border="0" alt="Kauf auf Rechnung" title="Novalnet AG" height="23" /></a></div><div style="float:left">Kauf auf Rechnung</div>';
...
$_['text_success']       		= 'erfolgreich: Sie haben ge&auml;ndert Novalnet Kauf auf Rechnung Modul!';
$_['text_novalnet_invoice'] 	= '<a href=\''.$shop_url.'www.novalnet.de\' target=\'_blank\'"><img src="'.$shop_url.'www.novalnet.de/img/NN_Logo_T.png" border="0" alt="novalnet.de" title="Novalnet AG" /></a>';
...
$_['entry_tariffid']       		= 'Novalnet Tarif ID<br /><span class="help">Geben Sie Ihre Novalnet Tarif-ID ein';
$_['entry_Payment_Duration']	= 'Zahlungsfrist in Tagen<br />';
...
// Error
$_['error_permission']      	= 'Warnung: Sie sind nicht berechtigt, die Zahlung &auml;ndern Novalnet Kauf auf Rechnung ';
$_['error_warning']    	    	= 'Bitte beheben Sie die folgenden Fragen zu aktualisieren Novalnet Kauf auf Rechnung Einstellungen!';
