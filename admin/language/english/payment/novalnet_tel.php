...
$_['heading_title']      	= 'Novalnet Telephone Payment ';
$_['admin_heading_title']   = '<div style="float:left"><a href=\''.$shop_url.'www.novalnet.com\' target=\'_blank\'"><img src="'.$shop_url.'www.novalnet.de/img/NN_Logo_T.png" border="0" alt="novalnet.com" title="Novalnet AG" height="23" /></a> </div><div style="float:right"><a href=\''.$shop_url.'www.novalnet.com\' target=\'_blank\'"><img src="'.$shop_url.'www.novalnet.de/img/novaltel_logo.png" border="0" alt="Telephone Payment" title="Novalnet AG" height="23" /></a></div><div style="float:left">Telephone Payment</div>';
...
$_['text_success']       	= 'Success: You have modified Novalnet Telephone payment module!';
$_['text_novalnet_tel']     = '<a href=\''.$shop_url.'www.novalnet.com\' target=\'_blank\'"><img src="'.$shop_url.'www.novalnet.de/img/NN_Logo_T.png" border="0" alt="novalnet.com" title="Novalnet AG" /></a>';
...
// Error
$_['error_permission']   	= 'Warning: You do not have permission to modify payment Novalnet Telephone';
$_['error_warning']    	  	= 'Kindly fix the following issues to update Novalnet Telephone settings!';
