...
$_['heading_title']      	= 'Novalnet Lastschrift Deutschland PCI ';
$_['admin_heading_title']   = '<div style="float:left"><a href=\''.$shop_url.'www.novalnet.de\' target=\'_blank\'"><img src="'.$shop_url.'www.novalnet.de/img/NN_Logo_T.png" border="0" alt="novalnet.de" title="Novalnet AG" height="23" /></a></div><div style="float:right"><a href=\''.$shop_url.'www.novalnet.de\' target=\'_blank\'"><img src="'.$shop_url.'www.novalnet.de/img/ELV_Logo.png" border="0" alt="Lastschrift Deutschland PCI" title="Novalnet AG" height="23" /></a></div><div style="float:right">Lastschrift Deutschland PCI</div>';
...
$_['text_success']       	= 'erfolgreich: Sie haben ge&auml;ndert Novalnet Lastschrift Deutschland PCI Modul!';
$_['text_novalnet_elv_de_pci']  = '<a href=\''.$shop_url.'www.novalnet.de\' target=\'_blank\'"><img src="'.$shop_url.'www.novalnet.de/img/NN_Logo_T.png" border="0" alt="novalnet.de" title="Novalnet AG" /></a>';
...
$_['entry_module']     		= 'Novalnet Lastschrift Deutschland PCI Modul aktivierung:<br/><span class="help"></span>';
...
// Error
$_['error_permission']      = 'Warnung: Sie sind nicht berechtigt, die Zahlung &auml;ndern Novalnet Lastschriftverfahren Deutschland PCI ';
$_['error_warning']    	    = 'Bitte beheben Sie die folgenden Fragen zu aktualisieren Novalnet Lastschriftverfahren Deutschland PCI Einstellungen!';
