...
$_['heading_title']      	= 'Novalnet Telefonpayment';
$_['admin_heading_title']   = '<div style="float:left"><a href=\''.$shop_url.'www.novalnet.de\' target=\'_blank\'"><img src="'.$shop_url.'www.novalnet.de/img/NN_Logo_T.png" border="0" alt="novalnet.de" title="Novalnet AG" height="23" /></a> </div><div style="float:right"><a href=\''.$shop_url.'www.novalnet.de\' target=\'_blank\'"><img src="'.$shop_url.'www.novalnet.de/img/novaltel_logo.png" border="0" alt="Telefonpayment" title="Novalnet AG" height="23" /></a></div><div style="float:left">Telefonpayment</div>';
...
$_['text_success']       	= 'erfolgreich: Sie haben ge&auml;ndert Novalnet Telefonpayment Modul!';
$_['text_novalnet_tel']     = '<a href=\''.$shop_url.'www.novalnet.de\' target=\'_blank\'"><img src="'.$shop_url.'www.novalnet.de/img/NN_Logo_T.png" border="0" alt="novalnet.de" title="Novalnet AG" /></a>';
...
$_['entry_module']     		= 'Enable Novalnet Telefonpayment Module<br/><span class="help"></span>';
...
// Error
$_['error_permission']      = 'Warnung: Sie sind nicht berechtigt, die Zahlung &auml;ndern Novalnet Telefone ';
$_['error_warning']    	    = 'Bitte beheben Sie die folgenden Fragen zu aktualisieren Novalnet Telefone Einstellungen!';
