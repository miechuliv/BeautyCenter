...
<div id="content">
 ...
 <div id="content_inside">
  ...
  <div class="product-info">
    ...
    <div class="left">
      <?php if ($thumb) { ?>
      <div class="image"><div class="image_inside"><a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class = 'cloud-zoom' id='zoom1' rel="tint: '#ffffff',tintOpacity:0.5 ,smoothMove:3,zoomWidth:379, zoomHeight:379, adjustY:-10, adjustX:23"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" /></a></div><div class="zoom_btn">
    ...
    <div class="right">
      ...
      <div class="price">
      	<span class='alt_font'>
      		<span class="text_price"><?php echo $text_price; ?></span>
        <?php if (!$special) { ?>
        	<span class="cyan_price"><span><?php echo $price; ?></span></span>
        <?php } else { ?>
        	<span class="price-old"><?php echo $price; ?></span> <span class="cyan_price price-new"><span><?php echo $special; ?></span></span>
        <?php } ?>
        </span>
      ...
      <div class="cart">
        <div><?php echo $text_qty; ?>
          ...
          &nbsp;<a onclick="addToWishList('<?php echo $product_id; ?>');" class="icon_plus"><?php echo $button_wishlist; ?></a> &nbsp;&nbsp;
          <a onclick="addToCompare('<?php echo $product_id; ?>');" class="icon_plus"><?php echo $button_compare; ?></a>
        <?php if ($minimum > 1) { ?>
      ...
      <div class="review">
        <div><img src="catalog/view/theme/fancycart/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;(<a onclick="$('a[href=\'#tab-review\']').trigger('click');" class='rev_count'><?php echo $reviews; ?></a>)&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');" class="icon_plus"><?php echo $text_write; ?></a></div>
  ...
  <?php if ($products) { ?>
  <h1 class="general_heading" style="margin-top: 26px;"><?php echo $tab_related; ?></h1>
...
new AjaxUpload('#button-option-<?php echo $option['product_option_id']; ?>', {
	...
	onSubmit: function(file, extension) {
		$('#button-option-<?php echo $option['product_option_id']; ?>').after('<img src="catalog/view/theme/fancycart/image/loading.gif" class="loading" style="padding-left: 5px;" />');
...
$('#button-review').bind('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#review-title').after('<div class="attention"><img src="catalog/view/theme/fancycart/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
