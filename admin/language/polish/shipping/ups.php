...
$_['text_success']                 = 'Sukces: zmodyfikowane UPS shipping!';
...
$_['text_today_staard']          = 'UPS Today Staard';
...
$_['entry_username']               = 'Użytkownik<span class="help">Enter your UPS Services account username.</span>';
$_['entry_password']               = 'Hasło:<span class="help">Enter your UPS Services account password.</span>';
...
$_['entry_classification']         = 'Customer Classification Kod:<span class="help">01 - If you are billing to a UPS account a have a daily UPS pickup, 03 - If you do not have a UPS account or you are billing to a UPS account but do not have a daily pickup, 04 - If you are shipping from a retail outlet (only used when origin is US)</span>';
$_['entry_origin']                 = 'Wysyłka Origin Kod:<span class="help">What origin point should be used (this setting affects only what UPS Nazwa Produktus are shown to the user)</span>';
...
$_['entry_postcode']               = 'Origin Zip/Postal Kod:<span class="help">Enter your origin zip/postalcode.</span>';
...
// Error
$_['error_permission']             = 'Ostrzeżenie: Nie masz uprawnień do modyfikowania UPS (US) shipping!';
$_['error_key']                    = 'Access Key Required!';
$_['error_username']               = 'Nazwa użytkownika Required!';
$_['error_password']               = 'Hasło Required!';
