...
$_['heading_title']      		= 'Novalnet Invoice';
$_['admin_heading_title']   	= '<div style="float:left"><a href=\''.$shop_url.'www.novalnet.com\' target=\'_blank\'"><img src="'.$shop_url.'www.novalnet.de/img/NN_Logo_T.png" border="0" alt="novalnet.com" title="Novalnet AG" height="23" /></a> </div><div style="float:right"><a href=\''.$shop_url.'www.novalnet.com\' target=\'_blank\'"><img src="'.$shop_url.'www.novalnet.de/img/kauf-auf-rechnung.jpg" border="0" alt="Invoice" title="Novalnet AG" height="23" /></a></div><div style="float:left">Invoice</div>';
...
$_['text_success']       		= 'Success: You have modified Novalnet Invoice payment module!';
$_['text_novalnet_invoice'] 	= '<a href=\''.$shop_url.'www.novalnet.com\' target=\'_blank\'"><img src="'.$shop_url.'www.novalnet.de/img/NN_Logo_T.png" border="0" alt="novalnet.com" title="Novalnet AG" /></a>';
...
$_['entry_Payment_Duration']	= 'Payment period in days<br />';
...
// Error
$_['error_permission']   		= 'Warning: You do not have permission to modify payment Novalnet Invoice';
$_['error_warning']    	  		= 'Kindly fix the following issues to update Novalnet Invoice settings!';
...
$_['error_duration']      		= 'Payment Duration Required!';
?>
